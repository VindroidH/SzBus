...
public class BusParser {
    ...
    public SearchResult search(String keyword) {
        ...
        try {
            ...
            Log.e(TAG, "[search] has exception", e);
        }
        return search;
    }

    public BusLineDetail getBusLine(String busLineId) {
    ...
    public BusLineRealTimeInfo getBusLineRealTimeInfo(String busLineId) {
    ...
    public StationDetail getStation(String stationId) {
