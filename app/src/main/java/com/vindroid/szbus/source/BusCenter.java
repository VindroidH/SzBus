...
import com.vindroid.szbus.source.szgj.BusParser;
import com.vindroid.szbus.source.szxing.BusApi;
...
public class BusCenter {
    ...
    public interface SZXingListener {
        void onGetVersionCompleted(String versionJson);
    }
        ...
        protected Boolean doInBackground(String... strings) {
            ...
            try {
                if (DataSource.SOURCE_SZXING.equals(DataSource.getDataSource())) {
                    mSearchResult = new BusApi().search(keyword);
                } else {
                    mSearchResult = new BusParser().search(keyword);
                }
                return true;
            } catch (Exception e) {
    ...
    public static class GetBusLine extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground(String... strings) {
            ...
            try {
                if (DataSource.SOURCE_SZXING.equals(DataSource.getDataSource())) {
                    mBusLine = new BusApi().getBusLine(id);
                } else {
    ...
    public static class GetStation extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground(String... strings) {
            ...
            try {
                if (DataSource.SOURCE_SZXING.equals(DataSource.getDataSource())) {
                    mStation = new BusApi().getStation(id);
                } else {
    ...
    public static class GetBusLineRealTimeInfo extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground(String... strings) {
            ...
            try {
                if (DataSource.SOURCE_SZXING.equals(DataSource.getDataSource())) {
                    mInfo = new BusApi().getBusLineRealTimeInfo(id);
                } else {
    ...
    public static class GetSZXingVersion extends AsyncTask<Void, Integer, String> {
        private final SZXingListener mListener;

        public GetSZXingVersion(SZXingListener listener) {
            mListener = listener;
        }
        ...
        protected String doInBackground(Void... voids) {
            try {
                return new BusApi().getLastUpdateTime();
            } catch (NetworkErrorException e) {
                Log.e(TAG, "[GetSZXingVersion] has exception", e);
            }
            return null;
        }
        ...
        protected void onPostExecute(String s) {
            ...
            if (mListener != null) {
                mListener.onGetVersionCompleted(s);
            }
        }
    }

    public static class UpdateSZXingVersion extends AsyncTask<Void, Integer, String> {
        private final SZXingListener mListener;

        public UpdateSZXingVersion(SZXingListener listener) {
            mListener = listener;
        }
        ...
        protected String doInBackground(Void... voids) {
            try {
                return new BusApi().getBusLineFile();
            } catch (NetworkErrorException e) {
                Log.e(TAG, "[GetSZXingVersion] has exception", e);
            }
            return null;
