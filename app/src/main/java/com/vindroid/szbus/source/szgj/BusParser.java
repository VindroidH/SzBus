package com.vindroid.szbus.source.szgj;
...
import com.vindroid.szbus.source.Node;
...
public class BusParser implements ICommonApi {
    private static final String TAG;

    public static final String URL_SITE = "https://2500.tv";
    public static final String URL_SEARCH = URL_SITE + "/line/search?keyword=";
    public static final String URL_BUS = URL_SITE + "/line/bus?id=";
    public static final String URL_STATION = URL_SITE + "/station/bus?id=";
    public static final String API_BUS_LINE = URL_SITE + "/api/v1/busline/bus?line_guid=";
    ...
    public SearchResult search(String keyword) throws NetworkErrorException {
        ...
        for (Node node : stationNodes) {
            ...
            station.setId(node.hrefWithSubString(URL_STATION.length()));
        ...
        for (Node node : busNodes) {
            busLine = new BusLine();
            busLine.setId(node.hrefWithSubString(URL_BUS.length()));
    ...
    public BusLineRealTimeInfo getBusLineRealTimeInfo(String busLineId) throws NetworkErrorException, JSONException {
        ...
        String api = API_BUS_LINE + busLineId;
    ...
    public StationDetail getStation(String stationId) throws NetworkErrorException {
        ...
        // TODO station detail info, such as name, address

        String url = URL_STATION + stationId;
        ...
        for (Node item : busNodes) {
            busLine = new InComingBusLine();
            busLine.setId(item.hrefWithSubString(URL_BUS.length()));
